    ...
    <group>
      ...
      >
        <div className="hologram-title">
          <h1 className="title-main">CollabRoom IDE</h1>
          <p className="title-sub">Real-time Collaborative Coding • 14+ Languages • Docker Execution</p>
          <div className="title-tech">
            <span>React</span> • <span>Socket.IO</span> • <span>Yjs CRDT</span> • <span>Docker</span> • <span>MongoDB</span>
          </div>
