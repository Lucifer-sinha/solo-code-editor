    ...
    <group>
      ...
      >
        <div className="file-tree-demo">
          ...
          <div className="file-item indent">📁 components</div>
          <div className="file-item indent2">📄 Editor.tsx</div>
          <div className="file-item indent2">📄 Terminal.tsx</div>
          <div className="file-item indent">📁 pages</div>
          <div className="file-item indent2">📄 Playground.tsx</div>
          <div className="file-item">📁 public</div>
